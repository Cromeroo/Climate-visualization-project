    ...
    const SlideOne = ({ imageUrl, text }) => (
        ...
        <div className="slide-container">
            <img src={Imagen4} alt="Descripción" className="slide-image" />
             ...
             <div className="slide-text">Es una plataforma colaborativa transdisciplinaria que integre perspectivas científicas y saberes locales en comunidades locales con especial relación a la variabilidad y cambio climático.</div>
   </div>      
</div> 
    );
